...
const ShoppingListScreenItem = ({listId, members, title, products, navigation}) => {
    ...
    const goToCheckList = () => {
        //console.log({listId})
        navigation.navigate('CheckItems', {list: myList})
    }

    const goToEditList = () => {
        //console.log({listId})
        navigation.navigate('EditItems', {name: listId})
    }

    const goToEditHistory = () => {
        //console.log({listId})
        navigation.navigate('EditHistory', {name: listId})
    }


    return (
        /*<View>
            <TouchableHighlight  onPress={goToList} style={styles.container}>
            <View>
                <Text style={globalStyles.headerText}>{listId}</Text>
                <Text>members: {members} </Text>
                <Text>Total Price: {price}</Text>
                </View>
            </TouchableHighlight>
            <TouchableHighlight>
                <Text> Mark Items</Text>
            </TouchableHighlight>
            <TouchableHighlight>
                <Text> Edit List</Text>
            </TouchableHighlight>
            <TouchableHighlight>
                <Text> View Edit History</Text>
            </TouchableHighlight>
        </View>*/
